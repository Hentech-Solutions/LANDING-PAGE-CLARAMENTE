  ...
  async function confirmConsent() {
    ...
    try {
      ...
      localStorage.setItem(
        "claramente_checkin",
        JSON.stringify({ ...pendingForm, topic, submittedAt }),
      );
      ...
      setError(
        "Não foi possível enviar seus dados agora. Confira sua conexão e tente novamente.",
      );
      setIsSending(false);
    }
  }
  ...
  return (
    <main className="site-shell">
      <div className="announcement">
        AVALIAÇÃO PSICOLÓGICA E NEUROPSICOLÓGICA · ITAQUAQUECETUBA + ONLINE
      </div>
      <nav className="nav-wrap" aria-label="Navegação principal">
        <Link href="/" className="brand-mark">
          <Image src={Logo} alt="Claramente" width={40} height={46} />
          <span>
            Claramente<span className="text-violet-400">&</span>Neurotec
            <small>Psicologia Aplicada</small>
          </span>
        </Link>
        <div className="nav-links">
          <Link href="/#a-clinica">A clínica</Link>
          <Link href="/#servicos">O que oferecemos</Link>
          <Link href="/#como-funciona">Como funciona</Link>
          <Link href="/#depoimentos">Depoimentos</Link>
          <a href="#contato">Contato</a>
        </div>
        <a className="nav-phone" href="tel:+5511982829179">
          (11) 98282-9179
        </a>
      ...
      <section
        className="checkin-section contact-page contact-section"
        id="contato"
      >
        <div className="checkin-aside">
          <p className="eyebrow">
            <span /> O PRÓXIMO PASSO É SÓ CONTINUAR A CONVERSA
          </p>
          <h1>
          ...
          <p className="contact-description">
            ...
            a conversa com nossa equipe pelo WhatsApp — sem compromisso e no seu
            tempo.
          </p>
        ...
        <div className="checkin-form">
          {submitted ? (
            <div className="form-success">
              ...
              <p className="eyebrow">
                <span /> envio concluído
              </p>
              <h2>Mensagem enviada com sucesso!</h2>
              <p>
                Obrigado pelo contato. Nossa equipe retornará no seu e-mail ou
                telefone em breve.
              </p>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-top">
                Formulário de Check-in (leva 1 minuto)
              </div>
              <label>
              ...
              <button
                className="button button-peach submit-button"
                type="submit"
              >
        ...
        >
          ...
          >
            ...
            {submitted ? (
              ...
              <>
                <p className="eyebrow">
                  <span /> antes de continuar
                </p>
                <h2 id="consent-title">Um aviso importante.</h2>
                <p>
                  A Claramente realiza atendimentos particulares e, atualmente,
                  não atende convênios nem oferece atendimentos gratuitos.
                </p>
                <p>
                  Ao prosseguir, você declara estar ciente dessas condições e
                  consente com a coleta e o uso dos dados informados
                  exclusivamente para que a equipe da Claramente entre em
                  contato sobre sua solicitação. Seus dados serão tratados com
                  confidencialidade, de acordo com a LGPD, e você pode solicitar
                  informações, correção ou exclusão deles pelos canais de
                  contato da clínica.
                </p>
